...
public class CamTest {
	...
	public void init() throws CamPositioningException {
		...
		originalView = PlacedRectangle.fromAnchorAndSize(0, 0, 50, 50, ApplicationContextUtils.mapDescriptorMain());
		cam = new Cam(Cam.CAM_MODE_CENTER_IN_SCENE, originalScene, 0, 0, originalView.width(), originalView.height(), ApplicationContextUtils.mapDescriptorMain());
	}
