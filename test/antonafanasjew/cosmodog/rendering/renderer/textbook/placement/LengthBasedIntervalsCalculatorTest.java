...
class LengthBasedIntervalsCalculatorTest {
	...
	void testRealExample() {
		...
		String s = "Ein Alphabet (fr�hneuhochdeutsch von kirchenlateinisch alphabetum) ist die Gesamtheit der kleinsten Schriftzeichen bzw. Buchstaben einer Sprache oder mehrerer Sprachen in einer festgelegten Reihenfolge. Die Buchstaben k�nnen �ber orthographische Regeln zu W�rtern verkn�pft werden und damit die Sprache schriftlich darstellen. Die im Alphabet festgelegte Reihenfolge der Buchstaben erlaubt die alphabetische Sortierung von W�rtern und Namen beispielsweise in W�rterb�chern. Nach einigen Definitionen ist mit Alphabet nicht der Buchstabenbestand in seiner festgelegten Reihenfolge gemeint, sondern die Reihenfolge selbst.";
