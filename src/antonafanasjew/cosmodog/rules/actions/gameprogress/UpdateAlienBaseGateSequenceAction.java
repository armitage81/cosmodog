...
public class UpdateAlienBaseGateSequenceAction extends AbstractRuleAction {
	...
	public void execute(GameEvent event) {
		...
		boolean inRegion5 = RegionUtils.pieceInRegion(player, ApplicationContextUtils.mapDescriptorMain(), region5);
		...
		if (inRegion1) {
			...
			if (currentSequenceNumber == 4) {
				...
				asyncAction = new CamCenteringDecoratorAction(1000, Position.fromCoordinates(237, 289, ApplicationContextUtils.mapDescriptorMain()), asyncAction);
