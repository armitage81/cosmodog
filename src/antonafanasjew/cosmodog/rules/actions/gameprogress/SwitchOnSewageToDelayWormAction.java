...
/**
 * Sets the worm appearance delay to phase 3.
 */
public class SwitchOnSewageToDelayWormAction extends AbstractRuleAction {

	private static final long serialVersionUID = 8620572862854412890L;

	@Override
	public void execute(GameEvent event) {	
		ApplicationContextUtils.getGameProgress().setTurnsTillWormAppears(GameProgress.TURNS_TILL_WORM_APPEARS_PHASE3);
	}
