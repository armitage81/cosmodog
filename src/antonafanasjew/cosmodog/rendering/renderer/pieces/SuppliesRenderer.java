...
public class SuppliesRenderer extends AbstractPieceRenderer {
	...
	protected void render(ApplicationContext applicationContext, int tileWidth, int tileHeight, int tileNoX, int tileNoY, Piece piece) {
		renderAsDefaultFeatureBoundGoodie(applicationContext, tileWidth, tileHeight, tileNoX, tileNoY, piece, Features.FEATURE_HUNGER);
	}
