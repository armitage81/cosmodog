...
public enum FontType {
	...
	CutsceneNarration(new TrueTypeFont(new Font("Courier New", Font.PLAIN, 18), false), Color.green),
	MemoryNarration(new TrueTypeFont(new Font("Courier New", Font.PLAIN, 18), false), Color.green),
	EndingNarration(new TrueTypeFont(new Font("Courier New", Font.PLAIN, 18), false), Color.green),
	GameLog(new TrueTypeFont(new Font("Courier New", Font.PLAIN, 16), false), Color.white),
	GameLogPlayer(new TrueTypeFont(new Font("Courier New", Font.PLAIN, 16), false), Color.white),
