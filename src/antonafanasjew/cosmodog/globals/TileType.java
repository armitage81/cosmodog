...
public enum TileType {
	...
	FIRSTAIDKIT(Layers.LAYER_META_COLLECTIBLES,3116),
	...
	PORTALGUN(Layers.LAYER_META_COLLECTIBLES,3115),
	NIGHTVISION(Layers.LAYER_META_COLLECTIBLES,3117),
	MOTIONTRACKER(Layers.LAYER_META_COLLECTIBLES,3118),
	...
	DYNAMIC_PIECE_ALIENCRATE(Layers.LAYER_META_DYNAMIC_PIECES, 2130),
	...
	DYNAMIC_PIECE_BOLLARD_RISEN(Layers.LAYER_META_DYNAMIC_PIECES, 5806),
	DYNAMIC_PIECE_BOLLARD_SUNK(Layers.LAYER_META_DYNAMIC_PIECES, 5807),
	DYNAMIC_PIECE_SWITCH(Layers.LAYER_META_DYNAMIC_PIECES, 5808),
	DYNAMIC_PIECE_AUTOBOLLARD(Layers.LAYER_META_DYNAMIC_PIECES, 5809),
	DYNAMIC_PIECE_JAMMER(Layers.LAYER_META_DYNAMIC_PIECES, 5810),
	DYNAMIC_PIECE_JAMMER_INVISIBLE(Layers.LAYER_META_DYNAMIC_PIECES, 5826),
	DYNAMIC_PIECE_SENSOR(Layers.LAYER_META_DYNAMIC_PIECES, 5812),
	DYNAMIC_PIECE_REFLECTOR_NW(Layers.LAYER_META_DYNAMIC_PIECES, 5816),
	DYNAMIC_PIECE_REFLECTOR_NE(Layers.LAYER_META_DYNAMIC_PIECES, 5817),
	DYNAMIC_PIECE_REFLECTOR_SE(Layers.LAYER_META_DYNAMIC_PIECES, 5818),
	DYNAMIC_PIECE_REFLECTOR_SW(Layers.LAYER_META_DYNAMIC_PIECES, 5819),

	DYNAMIC_PIECE_ONE_WAY_BOLLARD_WEST(Layers.LAYER_META_DYNAMIC_PIECES, 5820),
	DYNAMIC_PIECE_ONE_WAY_BOLLARD_NORTH(Layers.LAYER_META_DYNAMIC_PIECES, 5821),
	...
	DYNAMIC_PIECE_TRAFFIC_BARRIER_VERTICAL_LAST(Layers.LAYER_META_DYNAMIC_PIECES, 2646),

	DYNAMIC_PIECE_TRAFFIC_BARRIER_HORIZONTAL_FIRST(Layers.LAYER_META_DYNAMIC_PIECES, 2647),
	DYNAMIC_PIECE_TRAFFIC_BARRIER_HORIZONTAL_LAST(Layers.LAYER_META_DYNAMIC_PIECES, 2664),

	DYNAMIC_PIECE_RACE_POLE_POSITION_HORIZONTAL(Layers.LAYER_META_DYNAMIC_PIECES, 2620),
	DYNAMIC_PIECE_RACE_POLE_POSITION_VERTICAL(Layers.LAYER_META_DYNAMIC_PIECES, 2621),
	DYNAMIC_PIECE_RACE_FINISH_LINE_HORIZONTAL(Layers.LAYER_META_DYNAMIC_PIECES, 2622),
	DYNAMIC_PIECE_RACE_FINISH_LINE_VERTICAL(Layers.LAYER_META_DYNAMIC_PIECES, 2623),

	DYNAMIC_PIECE_RACE_EXIT(Layers.LAYER_META_DYNAMIC_PIECES, 2624),

	DYNAMIC_PIECE_TIME_BONUS_1(Layers.LAYER_META_DYNAMIC_PIECES, 100),
	DYNAMIC_PIECE_TIME_BONUS_2(Layers.LAYER_META_DYNAMIC_PIECES, 101),
	DYNAMIC_PIECE_TIME_BONUS_3(Layers.LAYER_META_DYNAMIC_PIECES, 102),
	DYNAMIC_PIECE_TIME_BONUS_4(Layers.LAYER_META_DYNAMIC_PIECES, 103),
	DYNAMIC_PIECE_TIME_BONUS_5(Layers.LAYER_META_DYNAMIC_PIECES, 104),
	DYNAMIC_PIECE_TIME_BONUS_6(Layers.LAYER_META_DYNAMIC_PIECES, 105),
	DYNAMIC_PIECE_TIME_BONUS_7(Layers.LAYER_META_DYNAMIC_PIECES, 106),
	DYNAMIC_PIECE_TIME_BONUS_8(Layers.LAYER_META_DYNAMIC_PIECES, 107),
	DYNAMIC_PIECE_TIME_BONUS_9(Layers.LAYER_META_DYNAMIC_PIECES, 108),
	DYNAMIC_PIECE_TIME_BONUS_10(Layers.LAYER_META_DYNAMIC_PIECES, 109),
	DYNAMIC_PIECE_TIME_BONUS_20(Layers.LAYER_META_DYNAMIC_PIECES, 110),
	DYNAMIC_PIECE_TIME_BONUS_30(Layers.LAYER_META_DYNAMIC_PIECES, 111),
	DYNAMIC_PIECE_TIME_BONUS_40(Layers.LAYER_META_DYNAMIC_PIECES, 112),
	DYNAMIC_PIECE_TIME_BONUS_50(Layers.LAYER_META_DYNAMIC_PIECES, 113),

	DYNAMIC_PIECE_RESETTER(Layers.LAYER_META_DYNAMIC_PIECES, 118),
