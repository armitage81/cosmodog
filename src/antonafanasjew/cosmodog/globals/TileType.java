...
public enum TileType {
	...
	SUPPLIES(Layers.LAYER_META_COLLECTIBLES,TilesetConstants.FIRST_ID_META_COLLECTIBLES_TILESET),
	FIRSTAIDKIT(Layers.LAYER_META_COLLECTIBLES,SUPPLIES.getTileId() + 1),
	MEDIPACK(Layers.LAYER_META_COLLECTIBLES,FIRSTAIDKIT.getTileId() + 1),
