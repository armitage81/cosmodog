...
public class FightAction extends PhaseBasedAction {
	 ...
	 * <p>
	 * The player's life can be reduced to zero during the execution. In this case, the player's life listener is called.
	 * The player dies and will be respawned at the beginning of the map. It can also happen that the player is in a vehicle
	 * and the latter is destroyed as a result of the enemy attack.
	 *
