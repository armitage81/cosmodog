...
import antonafanasjew.cosmodog.rules.actions.async.CommentAction;
...
public class RegionDependentCommentRuleBuilder extends AbstractResourceWrapperBuilder<Rule> {
	...
	protected Rule build(String line) {
		...
		AsyncAction asyncAction = new CommentAction(labelText);
		...
		Rule rule = new Rule(ruleName, trigger, action, Rule.RULE_PRIORITY_30);
	...
	protected String resourcePath() {
		return "antonafanasjew/cosmodog/rulebuilder/regionmapping_comments.txt";
	}
